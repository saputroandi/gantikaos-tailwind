    ...
    return (
        <React.Fragment>
            ...
            <main className="my-8">
                ...
                <div className="fixed w-full py-3 bg-gradient-to-br from-blue-500 to-blue-400 bottom-0 lg:hidden">
                    <div className="flex flex-row justify-between px-6 mx-4">
                        <div className="flex-col">
                            <button className="opacity-60 rounded-xl focus:outline-none hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-lg p-2">
