...
export default function Home(){
    ...
    return (
        <React.Fragment>
                ...
                <div className="flex py-3 mx-4">
                    ...
                    <div className={`py-2 block mt-0`}>
                        <div className=" flex flex-col lg:flex-row place-content-between  w-40 mx-6 ">
                            <div className="py-2 lg:py-0"><button className="mx-1 p-2 opacity-60 rounded-xl focus:outline-none hover:bg-blue-800 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-md">Menu</button></div>
                            <div className="py-2 lg:py-0"><button className="mx-1 p-2 opacity-60 rounded-xl focus:outline-none hover:bg-blue-800 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-md">Profile</button></div>
                            <div className="py-2 lg:py-0"><button className="mx-1 p-2 opacity-60 rounded-xl focus:outline-none hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-md">Cart</button></div>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            {/* Carousel */}
            <div className="max-w-screen-2xl max-h-80 m-auto bg-red-500">
            ...
            <main className="my-8">
                    ...
                    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                        <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div className="flex items-end justify-end h-56 w-full bg-cover" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1495856458515-0637185db551?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80")'}}>
                                <button className="p-2 rounded-full shadow-lg bg-red-600 text-white mx-2 -mb-4 hover:bg-red-500 focus:outline-none focus:bg-blue-500">
                                ...
                                <button className="p-2 rounded-full shadow-lg bg-blue-600 text-white mx-2 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                ...
                <div className="fixed w-full py-2 bg-gradient-to-br from-blue-500 to-blue-400 bottom-0 lg:hidden">
                    <div className="flex flex-row justify-between px-6 mx-4">
                        <div className="flex-col">
                            <button className="opacity-60 rounded-xl focus:outline-none hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-lg p-1">
                                ...
                                <div>
                                    <p className="font-light text-xs">Menu</p>
                                </div>
                            </button>
                        </div>
                        <div className="flex-col">
                            <button className="opacity-60 rounded-xl focus:outline-none hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-lg p-1">
                                ...
                                <div>
                                    <p className="font-light text-xs">Profile</p>
                                </div>
                            </button>
                        </div>
                        <div className="flex-col">
                            <button className="opacity-60 rounded-xl focus:outline-none hover:bg-blue-700 focus:ring-1 focus:ring-blue-600 focus:opacity-100 focus:shadow-none shadow-lg p-1">
                                <div className="flex justify-center">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path></svg>
                                </div>
                                <div>
                                    <p className="font-light text-xs">Cart</p>
                                </div>
                            </button>
                        </div>
                    </div>
